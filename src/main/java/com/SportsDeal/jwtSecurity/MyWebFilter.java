package com.SportsDeal.jwtSecurity;
...
public class MyWebFilter implements Filter{
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
    	...
    	System.out.println(idUsuarioAutenticadoMedianteJWT);
    	...
    	if (metodoRequerido.equalsIgnoreCase("OPTIONS") || // Si se recibe una petición options, se deja pasar por el filtro
    			...
    			uriDePeticionWeb.equals("/usuario/datos") || // Web de autenticado, aunque no traiga JWT en la cabecera se le permite pasar
